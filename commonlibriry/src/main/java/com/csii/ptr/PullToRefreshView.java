...
import com.csii.ptr.header.KrHeader;
import com.csii.ptr.header.MaterialHeader;
import com.csii.ptr.loadmore.LoadMoreContainer;
import com.csii.ptr.loadmore.LoadMoreHandler;
import com.csii.ptr.loadmore.LoadMoreRecyclerViewContainer;
...
public class PullToRefreshView extends LinearLayout {
    ...
    public final class HeaderModeConstants {
        ...
        static final int MODE_MATERIAL = 1;
        static final int MODE_KE = 2;
    }
    ...
    private void buildPullDownView() {
        ...
        switch (mRefreshHeadMode) {
            ...
            case HeaderModeConstants.MODE_KE:
                view = new KrHeader(getContext());
                ((KrHeader) view).setShowRefreshInfo(true);
                break;
            case HeaderModeConstants.MODE_MATERIAL:
                ...
                view.setPadding(0, DeviceInfoUtil.dpTopx(getContext(), 15), 0, DeviceInfoUtil.dpTopx(getContext(), 10));
    ...
    private void setupViews() {
        ...
        mRecyclerView.setPadding(DeviceInfoUtil.dpTopx(getContext(), mPaddingLeft), 0, DeviceInfoUtil.dpTopx(getContext(), mPaddingRight), 0);
