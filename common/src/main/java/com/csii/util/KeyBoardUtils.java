...
public final class KeyBoardUtils {
	 ...
	 * @param vHandler
	 */
	public static void openKeyboard(Context context,Handler vHandler){
		openKeyboard(context,vHandler, DELAY_MILLIS);
	}
	 ...
	 * @param delayMillis
	 */
	public static void openKeyboard(final Context context, Handler vHandler, int delayMillis){
		if (vHandler != null && context != null){
			// 延迟打开
			vHandler.postDelayed(new Runnable() {
				@Override
				public void run() {
	 ...
	 * @param mDialog
	 */
	public static void closeKeyBoardSpecial(Context context,EditText mEditText, Dialog mDialog){
		try {
			// 关闭输入法
			...
			Timber.e(TAG, e, "closeKeyBoardSpecial");
		}
	}
	 ...
	 * @param vHandler
	 */
	public static void closeKeyBoardSpecial(Context context,final EditText mEditText, final Dialog mDialog, Handler vHandler){
		closeKeyBoardSpecial(context,mEditText, mDialog, vHandler, DELAY_MILLIS);
	}
	 ...
	 * @param delayMillis
	 */
	public static void closeKeyBoardSpecial(final Context context, final EditText mEditText, final Dialog mDialog, Handler vHandler, int delayMillis){
		if (vHandler != null){
			// 延迟打开
			vHandler.postDelayed(new Runnable() {
				@Override
				public void run() {
					closeKeyBoardSpecial(context,mEditText, mDialog);
				}
			}, delayMillis);
		}
	}
	 ...
	 * @param vHandler
	 */
	public static void closeKeyboard(Context context,Handler vHandler){
		closeKeyboard(context,vHandler, DELAY_MILLIS);
	}
	 ...
	 * @param delayMillis
	 */
	public static void closeKeyboard(final Context context, Handler vHandler, int delayMillis){
		if (vHandler != null && context != null){
			// 延迟打开
			vHandler.postDelayed(new Runnable() {
				@Override
	...
	private static int getContentViewInvisibleHeight(final Activity activity) {
		try {
			...
			Timber.e(TAG, e, "getContentViewInvisibleHeight");
			return 0;
		}
	}
	...
	public static void registerSoftInputChangedListener(final Activity activity, final OnSoftInputChangedListener listener) {
		try {
			...
			Timber.e(TAG, e, "registerSoftInputChangedListener");
		}
	}
			...
			public void onGlobalLayout() {
				if (listener != null){
					try {
						...
						Timber.e(TAG, e, "registerSoftInputChangedListener2");
					}
				}
			}
		});
